...
public class JSONRestController extends HttpServlet {
			//HttpServlet implementa la interfaz Serialization
			//Identificador para el tipo de onjeto HttpServlet
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		StringBuilder sb = new StringBuilder(); //Sirve para concatenar 
